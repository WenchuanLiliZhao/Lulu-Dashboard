      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: 'var(--color-text-sec)' }}>
            ...
            <div>color: var(--color-semantic-success-secondary);</div>
